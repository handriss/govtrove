...
const TEMPLATE_FIELDS: Record<string, TemplateField[]> = {
  ...
  'digest.html': [
    ...
    { name: 'SearchAlerts', label: 'SearchAlerts', type: 'json', default: JSON.stringify([{ SearchName: "Cybersecurity Services", MatchCount: 5, SearchURL: "https://app.govtrove.com/?q=cybersecurity", HistoryURL: "https://app.govtrove.com/search/1/history", TopOpportunities: [{ Title: "Enterprise Cybersecurity Assessment and Penetration Testing", URL: "https://app.govtrove.com/opportunity/1687095" }, { Title: "Cybersecurity Operations Center (CSOC) Support", URL: "https://app.govtrove.com/opportunity/1687201" }, { Title: "Zero Trust Architecture Implementation Support", URL: "https://app.govtrove.com/opportunity/1687312" }], HasMore: true, RemainingCount: 2 }, { SearchName: "Logistics", MatchCount: 12, SearchURL: "https://app.govtrove.com/?q=logistics", HistoryURL: "https://app.govtrove.com/search/2/history", TopOpportunities: [{ Title: "Logistics Management and Supply Chain Support", URL: "https://app.govtrove.com/opportunity/1686500" }, { Title: "Third-Party Logistics (3PL) Warehouse Operations", URL: "https://app.govtrove.com/opportunity/1686501" }, { Title: "Defense Logistics Information System Modernization", URL: "https://app.govtrove.com/opportunity/1686502" }], HasMore: true, RemainingCount: 9 }], null, 2) },
    { name: 'OpportunityAlerts', label: 'OpportunityAlerts', type: 'json', default: JSON.stringify([{ OpportunityTitle: "Cloud Migration and Managed Services", SolicitationNumber: "FA8750-26-R-0003", Summary: "Response deadline extended to April 2026.", OpportunityURL: "https://app.govtrove.com/opportunity/1685100" }], null, 2) },
    { name: 'UnsubscribeURL', label: 'UnsubscribeURL', type: 'text', default: UNSUB_DEFAULT },
  ],
};
