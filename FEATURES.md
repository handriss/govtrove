...
- [x] **Smart notice type defaults** — pre-select the notice types contractors care about (Solicitations, Combined Synopsis, Sources Sought) rather than showing everything. Pure UX improvement
...
- [x] **"What's new today?" one-click filter** — sort by Last Updated Date, filter to last 1-2 days. Every practitioner guide recommends this daily workflow — make it a single button
